...
class TestInfluxDBClient3(unittest.TestCase):
    ...
    async def test_query_async(self):
        with ConstantFlightServer() as server:
            ...
            assert {'data': 'database', 'reference': 'my_db', 'value': -1.0, 'null_value': None} in result_list
            assert {'data': 'sql_query', 'reference': query, 'value': -1.0, 'null_value': None} in result_list
            assert {'data': 'query_type', 'reference': 'sql', 'value': -1.0, 'null_value': None} in result_list
